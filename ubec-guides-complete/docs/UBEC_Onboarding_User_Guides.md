...
- ðŸŒ¾ **Farmer** - Small-scale regenerative agriculture practitioner
- ðŸ˜ï¸ **Community** - Organized group working on food sovereignty
- ðŸŒŸ **Community Activator** - Facilitator and capacity builder

---

## Table of Contents

1. [Getting Started: What You Need to Know](#getting-started)
2. [Farmer Onboarding Guide](#farmer-onboarding)
3. [Community Onboarding Guide](#community-onboarding)
4. [Community Activator Onboarding Guide](#community-activator-onboarding)
5. [Technical Setup: Creating Your Stellar Wallet](#technical-setup)
6. [Understanding Your Holonic Journey](#holonic-journey)
7. [Support and Resources](#support-resources)
...
âœ… **Commitment to regenerative practices** (healing, not extracting)  
âœ… **Human-scaled operations** (not industrial)  
âœ… **Symbiotic relationships** with ecosystems  
âœ… **Sustainable methodologies** (long-term viability)  
âœ… **Focus on local food sovereignty** (community control)  
âœ… **Community benefit orientation** (we prosper together)
...
ðŸŒ¬ï¸ **UBEC (Air)** - Your gateway token for accessing the ecosystem  
ðŸ’§ **UBECrc (Water)** - For reciprocal exchanges with other participants  
ðŸŒ **UBECgpi (Earth)** - Stable foundation for long-term holdings  
ðŸ”¥ **UBECtt (Fire)** - Rewards for transformative regenerative actions

---

<a name="farmer-onboarding"></a>
# ðŸŒ¾ FARMER ONBOARDING GUIDE
...
This doesn't need to be fancyâ€”authenticity matters more than polish. Include:
...
- Be reasonableâ€”regeneration takes time
...
**How to Prepare:**
- Clean up a bit, but don't "stage"â€”authenticity matters
...
**They're Evaluating:**
âœ“ Regenerative commitment and potential  
âœ“ Scale appropriateness  
âœ“ Community benefit  
âœ“ Sustainability indicators  
âœ“ Symbiotic relationships with ecosystem  
âœ“ Alignment with UBEC values
...
- Conversational toneâ€”you're telling your story
- Submit through online portal

**Purpose:**
- Not about judgmentâ€”about learning and support
...
- Not a one-time grantâ€”this is a relationship
...
âœ… **Implement regenerative practices** as agreed in your plan  
âœ… **Report on progress** quarterly (Years 1-2) or annually (Year 3+)  
âœ… **Participate in knowledge sharing** (answer questions, share learnings)  
âœ… **Contribute to local food production** (the core mission!)  
âœ… **Build relationships** with other ecosystem participants  
âœ… **Maintain commitment** to sustainability principles  
âœ… **Share learnings AND challenges** (both are valuable!)  
âœ… **Use tokens responsibly** and transparently  
âœ… **Uphold Ubuntu values** ("I am because we are")
...
# ðŸ˜ï¸ COMMUNITY ONBOARDING GUIDE
...
- Don't hide challengesâ€”authenticity matters
...
- This isn't a grant that endsâ€”it's ongoing membership
- Continue earning tokens through participation
...
âœ… **Implement your project** as outlined in agreement  
âœ… **Report quarterly** on progress, finances, and impact  
âœ… **Maintain democratic governance** and collective decision-making  
âœ… **Demonstrate financial transparency** in token usage  
âœ… **Share knowledge** with other communities  
âœ… **Contribute to food sovereignty** goals  
âœ… **Build regenerative practices** into your work  
âœ… **Foster Ubuntu principles** within your community  
âœ… **Participate in the network** (not isolated)  
âœ… **Support community members** to be active participants  
âœ… **Uphold UBEC values** in all activities
...
<a name="community-activator-onboarding"></a>
# ðŸŒŸ COMMUNITY ACTIVATOR ONBOARDING GUIDE
...
- Don't oversellâ€”be realistic about capacity
...
âœ… **Deliver on your scope of work** with excellence and care  
âœ… **Report monthly** with thoroughness and transparency  
âœ… **Serve participants** with humility and responsiveness  
âœ… **Document and share** knowledge for the commons  
âœ… **Build network** connections and collaborations  
âœ… **Embody Ubuntu principles** in all your work  
âœ… **Practice cultural humility** and responsiveness  
âœ… **Maintain boundaries** and sustainable practice  
âœ… **Participate in governance** and collective decision-making  
âœ… **Support peer activators** generously  
âœ… **Stay accountable** to communities you serve  
âœ… **Keep learning** and growing your capacity
...
# ðŸ’» TECHNICAL SETUP: Creating Your Stellar Wallet

## For All Participants (Farmers, Communities, Activators)

### Why You Need a Stellar Wallet

UBEC tokens live on the **Stellar blockchain**. To receive, hold, and use your tokens, you need a Stellar walletâ€”think of it as your digital account for UBEC participation.
...
3. **Write down your secret key** (the 56-character code starting with "S")
   ...
   - This is like the key to your houseâ€”lose it, lose everything
...
New Stellar wallets need a small amount of XLM (Stellar's native currency) to activateâ€”around 2 XLM (~$0.20-0.50 USD).

**Options:**
1. **UBEC can activate it for you** (easiestâ€”ask during onboarding)
...
**You'll receive the exact issuer addresses during onboardingâ€”these are critical to get right!**
...
### DO:
âœ… Write down secret key on paper  
âœ… Store secret key in safe/secure location  
âœ… Make multiple copies, stored separately  
âœ… Use a PIN/password for daily wallet access  
âœ… Keep wallet software updated  
âœ… Verify addresses before sending  
âœ… Start with small test transactions  

### DON'T:
âŒ Ever share your secret key with anyone  
âŒ Store secret key digitally (no screenshots, photos, cloud storage)  
âŒ Use the same secret key as your password  
âŒ Send large amounts without testing first  
âŒ Click suspicious links about "urgent wallet issues"  
âŒ Give wallet access to untrusted apps  

### For Communities with Multi-Signature:
âœ… Document signing process clearly  
âœ… Train all keyholders  
âœ… Practice with test transactions  
âœ… Have backup signers identified  
âœ… Review large transactions collectively  
âœ… Keep keyholder contact info updated  
...
- Try againâ€”network might have been temporarily busy
...
<a name="holonic-journey"></a>
# ðŸŒŸ UNDERSTANDING YOUR HOLONIC JOURNEY

## What is Holonic Evaluation?

The UBEC system views every participant as a "holon"â€”simultaneously an individual whole AND part of a larger whole. Just like you are a complete person AND also part of your family, your community, your bioregion, and the global ecosystem.
...
**How to strengthen this:**
- Don't just receive tokensâ€”also spend/trade them
...
### ðŸ”µ Contributor (Score: 0.6-0.8)
...
**Months 4-12: Participant â†’ Contributor (0.5-0.7)**
...
**Years 2-3: Contributor â†’ Integrator (0.7-0.85)**
...
**Years 4+: Integrator â†’ Exemplar (0.85-0.95)**
- Regional model
...
**Months 7-18: Contributor â†’ Integrator (0.7-0.85)**
- Project maturing
...
**Years 5+: Integrator â†’ Exemplar (0.85-0.95)**
...
**Years 2-3: Integrator â†’ Exemplar (0.9-0.95)**
...
**Helps Your Score:**
âœ… Balanced transactions (buying AND selling)  
âœ… Diverse relationships (trading with many people)  
âœ… Consistent activity (regular participation)  
âœ… Token circulation (not just hoarding)  
âœ… Positive reports showing impact  
âœ… Community feedback and verification  
âœ… Network participation (events, forums, collaboration)  
âœ… Knowledge sharing  
âœ… Mentoring or supporting others  
âœ… Evidence of regenerative impact  

**Hurts Your Score:**
âŒ Only receiving, never giving  
âŒ Accumulating without circulating  
âŒ One-sided relationships  
âŒ Minimal network participation  
âŒ Poor reporting or transparency  
âŒ No evidence of impact  
âŒ Isolated behavior  
âŒ Extractive patterns  
...
We're in this together. ðŸŒ±ðŸŒðŸ’š
...
*May your journey with UBEC be one of growth, connection, and transformation. Welcome!* ðŸŒŸ
